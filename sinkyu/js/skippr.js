(function () {    
    ...
    var Skippr = (function () {
        ...
        Skippr.prototype.navBuild = function() {
        	...
        	// append html to bubbles slidercontainer div.
        	slidercontainer = '<nav class="skippr-nav-slidercontainer">' + navElements + '</nav>';

        	_.$element.append(slidercontainer);
